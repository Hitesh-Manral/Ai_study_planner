...
google_calendar_credentials = os.getenv('C:\\Users\\hites\\OneDrive\\Desktop\\Ai-study_planner\\ai-study-439317-979488e77360.json')

def chat_with_gpt(user_input):
    try:
        completion = client.chat.completions.create(
    model="gpt-4o-mini",  # Updating to GPT-4o-mini
    store=True,  # If you want to store the conversation history
    messages=[{"role": "user", "content": user_input}]
)
        # Access the content properly
        print('RESPONSE###### ', type(completion.choices[0].message.content.strip()))  # Print the entire response for debugging
        return completion.choices[0].message.content.strip()  # Correctly access the content
...
def index():
    if request.method == 'POST':
        ...
        # Use GPT-4 to generate the schedule
        ...
        credentials = service_account.Credentials.from_service_account_file('C:\\Users\\hites\\OneDrive\\Desktop\\Ai-study_planner\\ai-study-439317-979488e77360.json')
